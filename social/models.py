...
from .exceptions import AlreadyExistsError, AlreadyFriendsError,FromUserToUserSame
...
class FriendshipManager(models.Manager):
    ...
    def add_friend(self, from_user, to_user, message=None):
        ...
        if from_user == to_user:
            raise FromUserToUserSame("Ok,It seems you are sending friend request to yourself!!!!")
